...
class ImportExportManager {
  ...
  async importData(importData) {
    const mergeMode = await this.askMergeMode(importData);
  ...
  askMergeMode(importData) {
    return new Promise((resolve) => {
      const modal = this.createImportDialog(importData, resolve);
  ...
  createImportDialog(importData, callback) {
